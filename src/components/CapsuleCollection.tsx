  ...
  return (
    <div className="flex">
        <div className="flex gap-8 w-full relative aspect-[2/1]">
            <Image src="/abstract.jpg" alt='' width={2000} height={1359} />
            <div className="flex flex-col items-start text-white p-[55px] bottom-0 left-0 absolute">
            <span className="text-base text-left font-semibold mb-2">Capsule</span>
            <h2 className="text-[54px] text-left leading-[58px] font-medium mb-6">Capsule collection</h2>
